...
export function PageLinks({
  ...
  return (
    <div className={clsx('relative pt-24 sm:pt-32 lg:pt-40', className)}>
      <div className="absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl bg-gradient-to-b from-neutral-50 via-accentTwo via-50% to-secondary">
        <GridPattern
      ...
      <SectionIntro title={title} invert smaller>
        {intro && <p>{intro}</p>}
      </SectionIntro>
